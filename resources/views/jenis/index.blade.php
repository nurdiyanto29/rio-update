...
@section('content')
    <div class="content-wrapper">
        ...
        <div class="modal fade" id="jenis" tabindex="-1" role="dialog" aria-labelledby="JenisTitle"
            aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="JenisTitle">Tambah Jenis Barang</h5>
                    ...
                    <div class="modal-body">
                        <form action="{{ route('jenis.store') }}" name="form" id="form" method="post"
                            ...
                            <div class="form-group">
                                <label style="color: #6c757d">Kode</label>

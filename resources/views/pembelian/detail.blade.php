                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td>Suppliyer</td>
                                        <td>: {{ $pembelian->suppliyer->nama ?? '' }}</td>
                                    </tr>
                                    <tr>
                                        <td>Tanggal</td>
                                        <td>: {{ tgl($pembelian->tanggal ?? '') }}</td>
                                    </tr>
                                    <tr>
                                        <td>User</td>
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($data as $dt)
                                            <tr>
                                                <td>{{ $x++ }}</td>
                                                <td>{{ tgl($dt->pembelian->tanggal) ?? '' }}</td>
                                                <td>{{ $dt->barang->nama ?? '' }}</td>
                                                <td>{{ $dt->barang->kode_barang ?? '' }}</td>

                                                @if ($dt->barang->satuan->parent_id)
                                                    <td>{{ $dt->jumlah / $dt->barang->satuan->kelipatan }}
                                                        {{ $dt->satuan->nama ?? '' }} atau {{ $dt->jumlah }}
                                                        {{ $dt->satuan->parent->nama ?? '' }} </td>
                                                @else
                                                    <td>{{ $dt->jumlah }} {{ $dt->satuan->nama ?? '' }}</td>
                                                @endif


                                                <td>@currency($dt->harga_satuan*$dt->barang->satuan->kelipatan)</td>

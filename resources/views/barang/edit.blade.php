                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="select2-selection select2-selection--single" id="jenis_id"
                                            ...
                                            @foreach ($data['jenis'] as $b)
                                                <option value={{ $b->id }}
                                                    {{ $b->id == $data['barang']->jenis_id ? 'selected' : '' }}>
                                                    {{ $b->nama }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select class="select2-selection select2-selection--single" id="satuan_id"
                                            ...
                                            @foreach ($data['satuan'] as $b)
                                                <option value={{ $b->id }}
                                                    {{ $b->id == $data['barang']->satuan_id ? 'selected' : '' }}>
                                                    {{ $b->nama }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="stok_awal" name="stok_awal"
                                            value="{{ $data['barang']->stok_awal }}" required>
                                    </div>
                                    <div class="form-group">
                                        <label style="color: #6c757d">Harga Satuan</label>
                                        <input type="text" class="form-control" id="harga_satuan" name="harga_satuan"
                                            value="{{ $data['barang']->harga_satuan }}" required>
                                    </div>
                                    <div class="form-group">
                                        <label style="color: #6c757d">Kadaluarsa (Opsional)</label>
                                        <input type="date" class="form-control" id="kadaluarsa" name="kadaluarsa"  value="{{ $data['barang']->kadaluarsa }}">
                                    </div>

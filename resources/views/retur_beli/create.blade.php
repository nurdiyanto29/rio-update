            ...
            <div class="container-fluid">
                <div class="invoice p-3 mb-3">
                    ...
                    <div class="row invoice-info">
                        <div class="col-lg-12">
                            <form action="{{ route('retur-beli.store') }}" onsubmit="return kirim()" name="form"
                                            ...
                                            <div class="col-md-12">
                                                <div class="row">
                                                    <div class="form-group col-md-6">
                                                        <select class="form-control inpt" id="id_pembelian"
                                                            name="idd=pembelian" style="width: 100%">
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-3">
                                                        <input type="text" class="form-control inpt" id="jumlah"
                                                            readonly placeholder="Jumlah Beli">
                                                    </div>
                                                    <div class="form-group col-md-3">
...
@push('js')
    ...
    <script>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        response.forEach(element => {
                            ...
                            var jumlah = `${element['jumlah']}`;
                            var kelipatan = `${element['kelipatan']}`;
                            var hasil = jumlah;
                            $('#jumlah').val(hasil);
                            $('#nama').val(
                                `${element['nama']}`
        ...
        $('#tambah').on('click', function() {
            ...
            var pembelian_id = $('#id_pembelian').val();
            ...
            if (jumlah && kode_barang && cek) {
                ...
                $('.incTbl').append(`
                        <tr>
                            <input type="hidden" readonly  class="kodein" name="kode[]" value=" ${pembelian_id}=${kode_barang}=${jumlah_kembali}=${alasan}=${barang_id}">
                                <td>${nama}</td>

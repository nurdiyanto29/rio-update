                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Retur Beli</h3>
                                <div class="form-group">
                                    @if (Auth::user()->role == 'Pegawai Gudang')
                                    <button class="btn btn-primary btn-sm float-right"
                                        onclick="window.location='{{ url('retur-beli/create') }}'" type="button">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('retur-beli.delete') }}" method="post">
                            @csrf
                            {{-- @method('DELETE') --}}
        ...
        <div class="modal fade" id="pdf" tabindex="-1" role="dialog" aria-labelledby="Delete" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{route('retur-beli.c')}}">
                            @csrf
                            <div class="form-group">

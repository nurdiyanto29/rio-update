...
@section('content')
    <div class="content-wrapper">
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-header">
                                <h3 class="card-title">Data Suppliyer</h3>
                                <div class="form-group">
                                    <button class="btn btn-primary btn-sm float-right" data-toggle="modal"
                                        data-target="#suppliyer" type="button">
        ...
        <div class="modal fade" id="suppliyer" tabindex="-1" role="dialog" aria-labelledby="JenisTitle"
            aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="JenisTitle">Tambah Suppliyer</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form action="{{ route('suppliyer.store') }}" name="form" id="form" method="post"
                            ...
                            <div class="form-group">
                                <label style="color: #6c757d">Nama Perusahaan</label>
            ...
            <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="Delete"
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ route('suppliyer.delete') }}" method="post">
                                @csrf
            ...
            <div class="modal fade" id="editmodal" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ route('suppliyer.update', $dt->id) }}" name="formedit" id="formedit"
